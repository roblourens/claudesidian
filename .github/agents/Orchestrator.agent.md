...
- Then, you delegate the plan to the TDD agent, which implements the plan
- Next, you delegate the plan and implementation to the QA agent, which verifies the implementation
- If the QA agent finds any issues, you send the issues back to the TDD agent
- You repeat the TDD and QA steps until the implementation is verified
